...
const Register = () => {
    ...
    const [useData, setUserData] = useState(initialState);

    const { fullname, username, email, password, cf_password } = useData;
    ...
    const handleSubmit = (e) => {
        e.preventDefault()
        dispactch(register(useData))
    };
    return (
        <div className="auth_page">
          <form onSubmit={handleSubmit}>
              <h3 className="text-uppercase text-center mb-4"> AT-Social Network</h3>
